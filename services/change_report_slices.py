"""Pre-commit slice grouping, validation, and workflow logic.

Extracted from change_report_service.py to reduce file size and improve
focus on the commit-slice orchestration concern.
"""
