...
def load_settings(project_root: Path | None = None) -> RuntimeConfig:
    ...
    return RuntimeConfig(
        ...
        embedding_batch_size=_get_int_env("CODER_EMBED_BATCH_SIZE", 48),
        ...
        embedding_device=os.environ.get("CODER_EMBED_DEVICE", "auto").strip().lower() or "auto",
        ...
        review_enabled=_get_bool_env("CODER_REVIEW_ENABLED", False),
